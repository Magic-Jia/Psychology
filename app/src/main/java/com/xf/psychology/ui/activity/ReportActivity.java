...
public class ReportActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        ...
        String advice;
        if (indeedsleeptime/(1000*60*60)< 360) { // 有效睡眠时长不足 6 小时
        ...
        } else if (onbedsleeptime/(1000*60*60) > 540 && indeedsleeptime/(1000*60*60) > 420) { // 睡眠时间充足且有效睡眠时间达标
            advice = "您的睡眠状况非常好，请继续保持良好的睡眠习惯。良好的睡眠习惯可以提高身体免疫力，保持身体和大脑的健康，有助于提高生活质量。建议您继续保持规律的睡眠时间和作息习惯。\n" +
                    "\n";
        } else if (onbedsleeptime/(1000*60*60) < 420) { // 总睡眠时间不足 7 小时
            advice = "您的睡眠时长不足，请尝试增加睡眠时间。长期睡眠不足可能会导致身体免疫力下降，记忆力减退，注意力不集中等问题。建议您制定一个规律的睡眠计划，保证充足的睡眠时间，让身体充分休息，保持良好的身体状态。";
        } else { // 其他情况
