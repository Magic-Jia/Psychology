...
public class NbButton1 extends androidx.appcompat.widget.AppCompatButton {
    ...
    public NbButton1(Context context) {
        super(context);
        init(context);
    }

    public NbButton1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public NbButton1(Context context, AttributeSet attrs, int defStyleAttr) {
